...
const Skills = ({ language }: SkillsProps) => {
  ...
  return (
    <section id="skills" className="relative py-32 px-6 lg:pl-32 bg-gradient-to-b from-transparent via-purple-900/10 to-transparent">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3">
                      {category.skills.map((skill, skillIndex) => (
                        <div
                          key={skillIndex}
                          className="px-4 py-2 rounded-xl bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 text-white/90 text-sm font-medium hover:border-purple-500/50 transition-colors"
                        >
                          {skill}
                        </div>
                      ))}
